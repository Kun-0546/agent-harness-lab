...
def cmd_draft(args: argparse.Namespace) -> int:
    ...
    HDL 不调模型起草实验 —— 那是外层 coding agent(Claude Code / Cursor /
    Codex)的活,据 brief.md 起草 program / versions / 测试集 / rubric /
    模拟器,完了走 hdl run / score / compare。HDL 这里只 scaffold:建实验
    目录、brief.md 模板、空的 versions/ 和 测试集/。幂等可重跑。
    """
    ...
    print(f"    versions/      —— 外层 agent 在此放版本文件")
