...
- **`design-v0.4.1.md`** —— v2 及以后的产品方向:agent 操作闭环、人拥有锚点;四模式、calibration、provenance、brief.md / review.md。
- **`archive/`** —— 已被取代的早期草稿(design-v0.1 / v0.2 / v0.4)和旧交接 note,留作记录。

一句话:`design-v0.3` + `file-formats` 是当前 v1,`design-v0.4.1` 是 v2+ 方向,`archive/` 是过去。
